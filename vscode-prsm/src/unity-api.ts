...
const PRIMITIVE_TYPES: UnityType[] = [
    {
        ...
        description: 'PrSM Int (System.Int32)',
        members: [
    ...
    },
    {
        ...
        description: 'PrSM Float (System.Single)',
        members: [
            { name: 'toString', kind: 'method', type: 'String', description: 'Convert to string', params: '()' },
    ...
    },
    {
        ...
        description: 'PrSM Double (System.Double)',
        members: [
            { name: 'toString', kind: 'method', type: 'String', description: 'Convert to string', params: '()' },
            { name: 'toInt', kind: 'method', type: 'Int', description: 'Truncate to Int', params: '()' },
            { name: 'toFloat', kind: 'method', type: 'Float', description: 'Convert to Float', params: '()' },
    ...
    },
    {
        ...
        description: 'PrSM Bool (System.Boolean)',
        members: [
            { name: 'toString', kind: 'method', type: 'String', description: 'Convert to string', params: '()' },
    ...
    },
    {
        ...
        description: 'PrSM String (System.String)',
        members: [
    ...
    },
    {
        ...
        description: 'PrSM Char (System.Char)',
        members: [
            { name: 'toString', kind: 'method', type: 'String', description: 'Convert to string', params: '()' },
    ...
    },
    {
        ...
        description: 'PrSM Long (System.Int64)',
        members: [
            { name: 'toString', kind: 'method', type: 'String', description: 'Convert to string', params: '()' },
    ...
    },
    {
        ...
        description: 'PrSM Byte (System.Byte)',
        members: [
            { name: 'toString', kind: 'method', type: 'String', description: 'Convert to string', params: '()' },
...
// PrSM keywords for completion
export const PRSM_KEYWORDS = [
...
// PrSM sugar functions
export interface PrSMBuiltin {
    name: string;
    params: string;
    description: string;
    prsmOnly?: boolean;
...
export const PRSM_BUILTINS: PrSMBuiltin[] = [
    { name: 'vec2', params: '(x, y)', description: 'Create Vector2', prsmOnly: true },
    { name: 'vec3', params: '(x, y, z)', description: 'Create Vector3', prsmOnly: true },
    { name: 'color', params: '(r, g, b, a)', description: 'Create Color', prsmOnly: true },
    { name: 'get', params: '<T>()', description: 'GetComponent<T>()', prsmOnly: true },
    { name: 'find', params: '<T>()', description: 'FindFirstObjectByType<T>()', prsmOnly: true },
    { name: 'Destroy', params: '(obj)', description: 'Destroy object' },
    { name: 'print', params: '(message, level?)', description: 'Debug.Log / LogWarning / LogError. Level: Log (default), Warn, Error', prsmOnly: true },
    { name: 'log', params: '(message)', description: 'Debug.Log(message)', prsmOnly: true },
    { name: 'warn', params: '(message)', description: 'Debug.LogWarning(message)', prsmOnly: true },
    { name: 'error', params: '(message)', description: 'Debug.LogError(message)', prsmOnly: true },
];
