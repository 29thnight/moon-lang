...
namespace Prism.Editor
{
    ...
    public static class PrismTemplates
    {
        public static string GetTemplate(string templateName)
        {
            ...
            {
                string templateFile = Path.Combine(packagePath, "Templates", templateName + ".prsm.txt");
        ...
        {
            // UPM package path
            string path = "Packages/com.prsm.editor";
            ...
            string[] searchPaths = {
                ...
                Path.Combine(Application.dataPath, "Plugins", "PrSM"),
            };
