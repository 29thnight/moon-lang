...
namespace Moon.Editor
{
    ...
    /// </summary>
    public static class MoonReflectionExtractor
    {
        private const string OutputDir = "Library/Moon";
        private const string OutputFile = "reflection_data.json";

        [MenuItem("Moon/Extract API Metadata", priority = 200)]
        public static void ExtractAll()
        {
            EditorUtility.DisplayProgressBar("Moon", "Extracting API metadata...", 0f);
            ...
            try
            {
                ...
                foreach (string asmName in assemblyNames)
                {
                    ...
                    EditorUtility.DisplayProgressBar("Moon",
                        $"Scanning {asmName}...",
                ...
                Debug.Log($"[Moon] Extracted {data.types.Count} types to {outputPath}");
            }
            finally
            {
