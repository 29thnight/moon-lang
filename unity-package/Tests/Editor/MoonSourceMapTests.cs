...
{
    public class MoonSourceMapTests
    {
        [Test]
        public void GetSourceMapPath_UsesMnmapSidecarExtension()
        {
            Assert.AreEqual(
                Path.Combine("Generated", "Moon", "Player.mnmap.json"),
                MoonSourceMap.GetSourceMapPath(Path.Combine("Generated", "Moon", "Player.cs")));
        }

        [Test]
        public void FindAnchorForGeneratedPosition_PrefersMostSpecificMemberSpan()
        {
            var sourceMap = new MoonGeneratedSourceMapFile
            {
                source_file = "Assets/Player.mn",
                generated_file = "Generated/Moon/Player.cs",
                declaration = new MoonGeneratedSourceMapAnchor
                {
                    qualified_name = "Player",
                    source_span = new MoonGeneratedSourceMapSpan { line = 1, col = 11, end_line = 1, end_col = 16 },
                    generated_span = new MoonGeneratedSourceMapSpan { line = 7, col = 1, end_line = 23, end_col = 1 },
                    generated_name_span = new MoonGeneratedSourceMapSpan { line = 7, col = 14, end_line = 7, end_col = 19 },
                },
                members = new[]
                {
                    new MoonGeneratedSourceMapAnchor
                    {
                        qualified_name = "Player.speed",
                        source_span = new MoonGeneratedSourceMapSpan { line = 2, col = 15, end_line = 2, end_col = 19 },
                        generated_span = new MoonGeneratedSourceMapSpan { line = 9, col = 1, end_line = 14, end_col = 5 },
                        generated_name_span = new MoonGeneratedSourceMapSpan { line = 10, col = 18, end_line = 10, end_col = 22 },
                    },
                    new MoonGeneratedSourceMapAnchor
                    {
                        qualified_name = "Player.jump",
                        source_span = new MoonGeneratedSourceMapSpan { line = 8, col = 10, end_line = 8, end_col = 13 },
                        generated_span = new MoonGeneratedSourceMapSpan { line = 18, col = 1, end_line = 22, end_col = 5 },
                        generated_name_span = new MoonGeneratedSourceMapSpan { line = 18, col = 17, end_line = 18, end_col = 20 },
                        segments = new[]
                        {
                            new MoonGeneratedSourceMapAnchor
                            {
                                qualified_name = "Player.jump#stmt1",
                                source_span = new MoonGeneratedSourceMapSpan { line = 9, col = 13, end_line = 9, end_col = 24 },
                                generated_span = new MoonGeneratedSourceMapSpan { line = 19, col = 1, end_line = 19, end_col = 32 },
                            },
                        },
                    },
                },
            ...
            MoonGeneratedSourceMapAnchor anchor = MoonSourceMap.FindAnchorForGeneratedPosition(sourceMap, 19, 1);
        ...
        {
            string projectRoot = Path.Combine(Path.GetTempPath(), "MoonSourceMapTests", Path.GetRandomFileName());
            string sourceFile = Path.Combine(projectRoot, "Assets", "Player.mn");
            string generatedFile = Path.Combine(projectRoot, "Generated", "Moon", "Player.cs");
  ...
  ""members"": [
    {
      ...
      ""source_span"": { ""line"": 8, ""col"": 10, ""end_line"": 8, ""end_col"": 13 },
            ...
            bool resolved = MoonSourceMap.TryResolveSourceLocation(projectRoot, generatedFile, 19, out string resolvedPath, out int resolvedLine, out int resolvedCol);
        ...
        public void LoadSourceMap_ParsesDeeplyNestedStatementSegments()
        {
            ...
            MoonGeneratedSourceMapFile sourceMap = MoonSourceMap.LoadSourceMap(generatedFile);
            MoonGeneratedSourceMapAnchor anchor = MoonSourceMap.FindAnchorForGeneratedPosition(sourceMap, 18 + nestingDepth, 1);
        ...
        private static string CreateNestedSourceMapJson(int depth)
        {
            ...
            builder.AppendLine("  \"source_file\": \"Assets/Player.mn\",");
            builder.AppendLine("  \"generated_file\": \"Generated/Moon/Player.cs\",");
