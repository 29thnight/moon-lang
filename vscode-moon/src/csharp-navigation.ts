import { MoonDefinitionEntry, MoonIndexResult, MoonIndexedSymbol } from './moonc-cli';

export interface MoonCSharpLookupTarget {
    typeName: string;
    memberName?: string;
}

export interface MoonCSharpHoverInfo extends MoonCSharpLookupTarget {
...
function getTargetFromDefinition(definition: MoonDefinitionEntry): MoonCSharpLookupTarget | null {
...
function getTargetFromSymbol(symbol: MoonIndexedSymbol): MoonCSharpLookupTarget | null {
