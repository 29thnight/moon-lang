...
fn build_hir_file_with_known_types(
    source_path: &Path,
    known_project_types: &HashMap<String, crate::semantic::types::MoonType>,
...
fn collect_project_types(files: &[PathBuf]) -> HashMap<String, crate::semantic::types::MoonType> {
    ...
    for file in &project_index.files {
        ...
        let ty = match decl.kind {
            DeclarationKind::Component => crate::semantic::types::MoonType::Component(decl.name.clone()),
            DeclarationKind::Asset => crate::semantic::types::MoonType::Asset(decl.name.clone()),
            DeclarationKind::Class | DeclarationKind::DataClass | DeclarationKind::Attribute => {
                crate::semantic::types::MoonType::Class(decl.name.clone())
            }
            DeclarationKind::Enum => crate::semantic::types::MoonType::Enum(decl.name.clone()),
        };
