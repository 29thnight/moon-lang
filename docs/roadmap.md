...
## 마일스톤 6: CLI ✅
- [x] `moonc compile <file>`
- [x] `moonc check <file>`
- [x] 배치 컴파일 (`moonc build`)
- [x] 진단 메시지 포맷 (텍스트/JSON)
- [x] `moonc init`, `moonc where`, `moonc version`
- [x] Watch 모드 (`moonc build --watch`)

## 마일스톤 7: Unity 에디터 패키지 ✅
- [x] ScriptedImporter (`.mn` 파일 자동 임포트)
- [x] MoonCompilerBridge (`moonc where`로 바이너리 탐색)
- [x] AssetPostprocessor (파일 변경/삭제/이름변경 감지)
- [x] 커스텀 인스펙터 (MoonComponentEditor, MoonScriptInspector)
